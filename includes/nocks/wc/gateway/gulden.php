...
class Nocks_WC_Gateway_Gulden extends Nocks_WC_Gateway_Abstract
{
    ...
    {
        return __('Gulden', 'nocks-crypto-for-woocommerce');
    }
	...
	{
		return __('Accept Gulden payments with Nocks', 'nocks-crypto-for-woocommerce');
	}
    ...
    protected function getDefaultDescription ()
    {
        ...
        return __('Pay with Gulden', 'nocks-crypto-for-woocommerce');
    }
    ...
    public function payment_fields() {
        ...
        try {
	        ...
	        $html = '<br/>' . __('Estimated total amount of Gulden: ', 'nocks-crypto-for-woocommerce') . ' ' . $this->getSourceCurrency() . ' ' . $amount;
        } catch(Exception $e) {
            $html = '<br/>' . __('We cannot calculate the amount of Guldens at this moment.', 'nocks-crypto-for-woocommerce');
        }
